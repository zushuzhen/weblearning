...
<template>
  <div>
    ...
    <div class="consulting">
      ...
      <div class="con-right" v-if="curNav.article">
        <div class="titlt" v-if="curNav.article.title">
          <i class="iconfont" style="font-size: 24px">&#xe84f;</i>
          {{ curNav.article.title }}
        </div>
        <div class="p" v-html="curNav.article.content"></div>
        <!-- <div class="boxImg">
          <img v-for="item in curNav.article.img" :key="item" :src="item.url" alt=""/>
        </div> -->
        <div class="time">联系电话：<span>{{curNav.article.contact}}</span></div>
      </div>
    </div>
  </div>
</template>
